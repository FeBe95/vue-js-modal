<template>
  <div>
    <div v-if="resizeEdges.includes('t')" class="vue-modal-top"></div>
    <div v-if="resizeEdges.includes('b')" class="vue-modal-bottom"></div>
    <div v-if="resizeEdges.includes('l')" class="vue-modal-left"></div>
    <div v-if="resizeEdges.includes('r')" class="vue-modal-right"></div>
    <div v-if="resizeEdges.includes('tr')" class="vue-modal-topRight"></div>
    <div v-if="resizeEdges.includes('tl')" class="vue-modal-topLeft"></div>
    <div v-if="resizeEdges.includes('br')" :id="getID" :class="className"></div>
    <div v-if="resizeEdges.includes('bl')" class="vue-modal-bottomLeft"></div>
  </div>
</template>
<script>
